...
part of 'account_registration_client.dart';
...
class _AccountRegistrationClient implements AccountRegistrationClient {
  _AccountRegistrationClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  });
  ...
  Future<SendOtpResponseModel> sendOtp(SendOtpRequestModel body) async {
    ...
    final _options = _setStreamType<SendOtpResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'https://dev.athlorun.connectonmap.com/v1/auth/send-otp',
  ...
  Future<VerifyOtpResponseModel> verifyOtp(VerifyOtpRequestModel body) async {
    ...
    final _options = _setStreamType<VerifyOtpResponseModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://dev.athlorun.connectonmap.com/v1/auth/verify-otp',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SelfieResponseModel> uploadSelfie(
    ...
    final _options = _setStreamType<SelfieResponseModel>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
      contentType: 'multipart/form-data',
        ...
        .compose(
          _dio.options,
          'https://dev.athlorun.connectonmap.com/v1/users/${id}/upload-profile-photo',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SelfieResponseModel _value;
    try {
      _value = SelfieResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<TargetsResponseModel> getTargets() async {
    ...
    final _options = _setStreamType<TargetsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TargetsResponseModel _value;
    try {
      _value = TargetsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
