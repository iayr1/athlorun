...
class LeaveParticipatedChallengesUsecase {
  final ChallengesRepository _challengesRepository;
  LeaveParticipatedChallengesUsecase(this._challengesRepository);

  Future<Either<Failure, LeaveParticipatedChallengesResponseModel>> call(
      String userId, String challengeId) async {
    try {
      return await _challengesRepository.leaveParticipatedChallenges(
          userId, challengeId);
    } catch (e, stackTrace) {
