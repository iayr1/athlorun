...
class AppTextStyles {
  ...
  static const TextStyle overlineSemiBold = TextStyle(
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w600,
    fontSize: 10,
    letterSpacing: 0,
  ...
  static const TextStyle heading5Medium = TextStyle(
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w500,
    fontSize: 20,
    letterSpacing: 0,
